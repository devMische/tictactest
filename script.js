...
function checkWin() {
    ...
    if(i1.classList[1] != undefined  && i1.classList[1] == i2.classList[1] && i1.classList[1] == i3.classList[1]) {
    ...
    if(i4.classList[1] != undefined  && i4.classList[1] == i5.classList[1] && i4.classList[1] == i6.classList[1]) {
    ...
    if(i7.classList[1] != undefined  && i7.classList[1] == i8.classList[1] && i7.classList[1] == i9.classList[1]) {
    ...
    if(i1.classList[1] != undefined  && i1.classList[1] == i4.classList[1] && i1.classList[1] == i7.classList[1]) {
        i1.classList.add('win');
        i4.classList.add('win');
        i7.classList.add('win');
    ...
    if(i2.classList[1] != undefined  && i2.classList[1] == i5.classList[1] && i2.classList[1] == i8.classList[1]) {
        i5.classList.add('win');
        i2.classList.add('win');
        i8.classList.add('win');
        playing = false;
    ...
    if(i3.classList[1] != undefined  && i3.classList[1] == i6.classList[1] && i3.classList[1] == i9.classList[1]) {
        i9.classList.add('win');
        i6.classList.add('win');
        i3.classList.add('win');
    ...
    if(i1.classList[1] != undefined  && i1.classList[1] == i5.classList[1] && i1.classList[1] == i9.classList[1]) {
        i1.classList.add('win');
        i5.classList.add('win');
        i9.classList.add('win');
    ...
    if(i3.classList[1] != undefined  && i3.classList[1] == i5.classList[1] && i3.classList[1] == i7.classList[1]) {
        i5.classList.add('win');
        i7.classList.add('win');
        i3.classList.add('win');
